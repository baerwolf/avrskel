...
{
  SET_OUTPUT_LOW(HD44780_RW);
  if (rs)
    SET_OUTPUT_HIGH(HD44780_RS);
  else
    SET_OUTPUT_LOW(HD44780_RS);
...
hd44780_init(void)
{
  SET_PIN_OUT(HD44780_RS);
  SET_PIN_OUT(HD44780_RW);
  SET_PIN_OUT(HD44780_E);
  ASSIGN(DDR, HD44780_D4, 0x0F);
